            ...
            <div className="container mx-auto px-4 pt-16 pb-8">
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 mb-16">
                    ...
                    <div className="space-y-6">
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-primary">Explore</h4>
                        <ul className="space-y-4">
                            <li>
                                <Link href="/" className="text-sm text-zinc-500 hover:text-secondary transition-colors">Home</Link>
                            </li>
                            <li>
                                <Link href="/products" className="text-sm text-zinc-500 hover:text-secondary transition-colors">Shop All</Link>
                            </li>
                            <li>
                                <Link href="/" className="text-sm text-zinc-500 hover:text-secondary transition-colors">Why Us</Link>
                            </li>
                            <li>
                                <Link href="/contact" className="text-sm text-zinc-500 hover:text-secondary transition-colors">Help</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-6">
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-primary">Collections</h4>
                        <ul className="space-y-4">
                            <li>
                                <Link href="/products?category=Rice" className="text-sm text-zinc-500 hover:text-secondary transition-colors">Premium Rice</Link>
                            </li>
                            <li>
                                <Link href="/products?category=Jaggery" className="text-sm text-zinc-500 hover:text-secondary transition-colors">Natural Jaggery</Link>
                            </li>
                            <li>
                                <Link href="/products?category=Nuts" className="text-sm text-zinc-500 hover:text-secondary transition-colors">Nuts & Seeds</Link>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-[10px] text-zinc-400 uppercase font-medium">Mon-Sat, 9AM-6PM</p>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
